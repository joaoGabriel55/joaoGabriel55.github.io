...
<div class="max-w-2xl space-y-6">
  <p class="text-body">
    {yearsExperience}+ years of experience. Skilled in building web
    applications/solutions with:
    <br />
    <span class="text-neutral-800 dark:text-neutral-200">React</span>,
    <span class="text-neutral-800 dark:text-neutral-200">TypeScript</span>,
    <span class="text-neutral-800 dark:text-neutral-200">Node.js</span>, and
    <span class="text-neutral-800 dark:text-neutral-200">Ruby on Rails</span>.
  </p>
